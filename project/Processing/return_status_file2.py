...
def get_return_status(all_data_dict):
    try :
        print("in get_tax_returns")
        this_key = all_data_dict["processing_data_dict"]["M1_primary"]["gst_returns"]
        ...
        all_data_dict["processing_data_dict"]["M1_primary"]["gst_returns"]=result_df
        print(result_df)
        return True

    except Exception as e:
        print("Error in return_status.py :", e)